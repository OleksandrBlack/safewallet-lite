...
FORMS += \
    ...
    src/depositsafecoin.ui \
    src/emoji.ui \
    src/encryption.ui \
    src/safecoinrequest.ui \
    src/mainwindow.ui \
    src/migration.ui \
    src/newseed.ui \
    src/newwallet.ui \
...
unix:        librust.target   = $$PWD/lib/target/release/libsafecoinwalletlib.a
else:win32:  librust.target   = $$PWD/lib/target/x86_64-pc-windows-gnu/release/safecoinwalletlib.lib
...
QMAKE_CLEAN += $$PWD/lib/target/release/libsafecoinwalletlib.a res/libsodium.a

win32: LIBS += -L$$PWD/lib/target/x86_64-pc-windows-gnu/release -lsafecoinwalletlib -L$$PWD/res/ -llibsodium -lsecur32 -lcrypt32 -lncrypt
else:macx: LIBS += -L$$PWD/lib/target/release -lsafecoinwalletlib -framework Security -framework Foundation -L$$PWD/res/ -lsodium
else:unix: LIBS += -L$$PWD/lib/target/release -lsafecoinwalletlib -ldl -L$$PWD/res/ -lsodium

win32: PRE_TARGETDEPS += $$PWD/lib/target/x86_64-pc-windows-gnu/release/safecoinwalletlib.lib $$PWD/res/liblibsodium.a
else:unix::PRE_TARGETDEPS += $$PWD/lib/target/release/libsafecoinwalletlib.a $$PWD/res/libsodium.a
