...
QString ChatItem::toChatLine()
{
    ...
    if (_outgoing == true)
    {
        ...
        moneyTextRequest = QString("<br>") + QString("<br>") + QString("<pr> Outgoing Safecoin Request </pr>") + QString("<b> <img src=':/icons/res/money-outgoing.png'><b>");
    }else{


        moneyTextRequest = QString("<br>") + QString("<br>") + QString("<pr> Incoming Safecoin Request </pr>") + QString("<b> <img src=':/icons/res/money-mouth.png'><b>");
