...
void MainWindow::showRequestsafecoin() {
 
    Ui_safecoinrequest req;
    QDialog d(this);
    req.setupUi(&d);
   ...
   QString label = ui->contactNameMemo->text();  
    ...
    req.txtFrom->setFocus();
        ...
        CAmount amount = CAmount::fromDecimalString(req.txtAmount->text());
        QString memoURI = "safecoin:" +  req.lblAddressInfo->text()
        ...
        // sapling address
        this->paysafecoinURI(sendURI,  req.lblAddressInfo->text());
