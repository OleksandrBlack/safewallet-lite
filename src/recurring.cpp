...
QString RecurringPaymentInfo::getAmountPretty() const {
    ...
    return currency == "USD" ? amount.toDecimalUSDString() : amount.toDecimalsafecoinString();
  } else if (Settings::getInstance()->get_currency_name() == "EUR") {
    return currency == "EUR" ? amount.toDecimalEURString() : amount.toDecimalsafecoinString();
  } else if (Settings::getInstance()->get_currency_name() == "BTC") {
    return currency == "BTC" ? amount.toDecimalBTCString() : amount.toDecimalsafecoinString();
     } else if (Settings::getInstance()->get_currency_name() == "CNY") {
    return currency == "CNY" ? amount.toDecimalCNYString() : amount.toDecimalsafecoinString();
  } else if (Settings::getInstance()->get_currency_name() == "RUB") {
    return currency == "RUB" ? amount.toDecimalRUBString() : amount.toDecimalsafecoinString();
     } else if (Settings::getInstance()->get_currency_name() == "CAD") {
    return currency == "CAD" ? amount.toDecimalCADString() : amount.toDecimalsafecoinString();
  } else if (Settings::getInstance()->get_currency_name() == "SGD") {
    return currency == "SGD" ? amount.toDecimalSGDString() : amount.toDecimalsafecoinString();
     } else if (Settings::getInstance()->get_currency_name() == "CHF") {
    return currency == "CHF" ? amount.toDecimalCHFString() : amount.toDecimalsafecoinString();
...
else return currency == "USD" ? amount.toDecimalUSDString() : amount.toDecimalsafecoinString();
}
